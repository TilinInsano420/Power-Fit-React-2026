...
const ManageMemberships = () => {
  ...
  const fetchMemberships = async () => {
    try {
      const res = await fetch(`${API_URL}/coach/membresias/`);
  ...
  const handleApprove = async (id) => {
    ...
    const res = await fetch(`${API_URL}/coach/aprobar-membresia/${id}/`, { method: "POST" });
    if (res.ok) {
  ...
  const handleReject = async (id) => {
    ...
    const res = await fetch(`${API_URL}/membresia/eliminar/${id}/`, { method: "DELETE" });
    if (res.ok) {
