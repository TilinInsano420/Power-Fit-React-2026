...
const Statistics = () => {
  ...
  useEffect(() => {
    fetch(`${API_URL}/estadisticas/membresias/?range=${selectedRange}`)
      .then((r) => r.json())
  ...
  useEffect(() => {
    fetch(`${API_URL}/estadisticas/asistencia/?range=${selectedRange}`)
      .then((r) => r.json())
  ...
  useEffect(() => {
    fetch(`${API_URL}/estadisticas/pagos/?range=${selectedRange}`)
      .then((r) => r.json())
      .then(setPagosData)
