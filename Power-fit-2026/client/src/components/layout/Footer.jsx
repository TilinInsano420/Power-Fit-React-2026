        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="flex gap-4 mb-6">
              <a href="https://www.instagram.com/powerfit_copiapo/" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-lg border border-green-500 flex items-center justify-center text-green-500 hover:bg-green-50 transition-colors">
                <Instagram size={20} />
              </a>
              <a href="https://www.facebook.com/PowerFITcopiapo/" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-lg border border-green-500 flex items-center justify-center text-green-500 hover:bg-green-50 transition-colors">
                <Facebook size={20} />
              </a>
            </div>
            <a href="https://www.instagram.com/powerfit_copiapo/" target="_blank" rel="noreferrer" className="inline-flex w-full items-center justify-center rounded-xl bg-green-500 px-4 py-3 font-semibold text-white hover:bg-green-600 transition-colors">Ver novedades</a>
          </div>
        </div>
